...
# Настройки
BACKEND_FIRST_IMAGE_NAME="backend_image"
BACKEND_SECOND_IMAGE_NAME="backend_2_image"
DESIGN_SYSTEM_IMAGE_NAME="corag22035/design-system-7"
IMAGE_TAG="latest"

FIRST_DIR="../../first-system/first_service"
SECOND_DIR="../../first-system/second_service"

DOCKER_USERNAME="corag22035"
DOCKER_PASSWORD="corag22035@pokeline.com"
...
push_image() {
  ...
  docker push $DESIGN_SYSTEM_IMAGE_NAME:$IMAGE_NAME
...
build_image $BACKEND_FIRST_IMAGE_NAME $FIRST_DIR
tag_image $BACKEND_FIRST_IMAGE_NAME $DESIGN_SYSTEM_IMAGE_NAME
push_image $BACKEND_FIRST_IMAGE_NAME $IMAGE_TAG

#build_image $BACKEND_SECOND_IMAGE_NAME $SECOND_DIR
#tag_image $BACKEND_SECOND_IMAGE_NAME $DESIGN_SYSTEM_IMAGE_NAME
#push_image $BACKEND_SECOND_IMAGE_NAME $IMAGE_TAG
